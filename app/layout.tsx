  ...
  return (
    <html lang="id">
      <body
        ...
        style={{ background: 'linear-gradient(180deg, #FAFBFD 0%, #F1F5F9 100%)', color: '#0F172A' }}
      >
        {/* Fixed atmospheric orbs — light premium */}
        <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
          ...
          <div style={{
            ...
            background: 'radial-gradient(circle, rgba(27,78,216,0.10) 0%, transparent 70%)',
            filter: 'blur(60px)',
            bottom: '10%', left: '35%',
          }} />
        </div>
