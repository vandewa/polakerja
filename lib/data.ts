...
export const layananData = [
  {
    ...
    itemDetails: [
      { name: 'ISO 9001', desc: 'Sistem Manajemen Mutu — fondasi standar untuk konsistensi kualitas produk dan layanan.' },
      { name: 'ISO 14001', desc: 'Sistem Manajemen Lingkungan — pengelolaan dampak lingkungan bisnis yang bertanggung jawab.' },
      { name: 'ISO 45001', desc: 'Sistem Manajemen K3 — perlindungan kesehatan dan keselamatan kerja karyawan.' },
      { name: 'ISO 37001', desc: 'Sistem Manajemen Anti Penyuapan — komitmen integritas bisnis bebas korupsi.' },
    ],
  },
  {
    id: 'legalitas',
